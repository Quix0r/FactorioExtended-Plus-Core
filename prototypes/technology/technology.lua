...
{
  {
    ...
    icon = "__FactorioExtended-Plus-Assets2__/core/technology/titanium-processing.png",
    icon_size = 128,
  ...
  },
  {
    ...
    icon = "__FactorioExtended-Plus-Assets2__/core/technology/hammer-wrench.png",
    icon_size = 128,
